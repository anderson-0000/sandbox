...
type WorkflowTemplateSpecTemplatesVolumesScaleIo struct {
	Gateway *string `field:"required" json:"gateway" yaml:"gateway"`
	SecretRef *WorkflowTemplateSpecTemplatesVolumesScaleIoSecretRef `field:"required" json:"secretRef" yaml:"secretRef"`
