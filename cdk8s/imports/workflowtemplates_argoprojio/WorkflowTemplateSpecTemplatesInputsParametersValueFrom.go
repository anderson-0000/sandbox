...
type WorkflowTemplateSpecTemplatesInputsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowTemplateSpecTemplatesInputsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
