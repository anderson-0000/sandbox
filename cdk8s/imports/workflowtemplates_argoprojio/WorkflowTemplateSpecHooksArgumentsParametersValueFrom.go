...
type WorkflowTemplateSpecHooksArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowTemplateSpecHooksArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
