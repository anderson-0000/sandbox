...
type WorkflowTemplateSpecTemplateDefaultsDagTasksArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowTemplateSpecTemplateDefaultsDagTasksArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
