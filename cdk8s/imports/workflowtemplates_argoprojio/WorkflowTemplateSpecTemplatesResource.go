...
type WorkflowTemplateSpecTemplatesResource struct {
	...
	ManifestFrom *WorkflowTemplateSpecTemplatesResourceManifestFrom `field:"optional" json:"manifestFrom" yaml:"manifestFrom"`
