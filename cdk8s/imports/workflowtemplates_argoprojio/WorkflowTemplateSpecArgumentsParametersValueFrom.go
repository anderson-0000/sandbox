...
type WorkflowTemplateSpecArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowTemplateSpecArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
