...
type WorkflowTemplateSpecTemplatesVolumesIscsi struct {
	...
	SecretRef *WorkflowTemplateSpecTemplatesVolumesIscsiSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
