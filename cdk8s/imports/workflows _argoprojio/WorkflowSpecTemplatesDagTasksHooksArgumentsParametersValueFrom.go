...
type WorkflowSpecTemplatesDagTasksHooksArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowSpecTemplatesDagTasksHooksArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
