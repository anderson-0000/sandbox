...
type WorkflowSpecTemplateDefaultsInputsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowSpecTemplateDefaultsInputsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
