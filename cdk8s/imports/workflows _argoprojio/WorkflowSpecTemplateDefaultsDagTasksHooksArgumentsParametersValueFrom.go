...
type WorkflowSpecTemplateDefaultsDagTasksHooksArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowSpecTemplateDefaultsDagTasksHooksArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
