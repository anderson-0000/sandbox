...
type WorkflowSpecTemplateDefaultsOutputsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowSpecTemplateDefaultsOutputsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
