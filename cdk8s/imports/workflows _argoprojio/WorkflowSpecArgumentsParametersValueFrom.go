...
type WorkflowSpecArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowSpecArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
