...
type CronWorkflowSpecWorkflowSpecVolumesScaleIo struct {
	Gateway *string `field:"required" json:"gateway" yaml:"gateway"`
	SecretRef *CronWorkflowSpecWorkflowSpecVolumesScaleIoSecretRef `field:"required" json:"secretRef" yaml:"secretRef"`
