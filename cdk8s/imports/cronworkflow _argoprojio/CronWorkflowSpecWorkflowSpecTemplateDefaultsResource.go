...
type CronWorkflowSpecWorkflowSpecTemplateDefaultsResource struct {
	...
	ManifestFrom *CronWorkflowSpecWorkflowSpecTemplateDefaultsResourceManifestFrom `field:"optional" json:"manifestFrom" yaml:"manifestFrom"`
