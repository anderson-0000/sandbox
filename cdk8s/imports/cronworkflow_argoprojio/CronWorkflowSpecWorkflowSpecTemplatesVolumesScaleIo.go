...
type CronWorkflowSpecWorkflowSpecTemplatesVolumesScaleIo struct {
	Gateway *string `field:"required" json:"gateway" yaml:"gateway"`
	SecretRef *CronWorkflowSpecWorkflowSpecTemplatesVolumesScaleIoSecretRef `field:"required" json:"secretRef" yaml:"secretRef"`
