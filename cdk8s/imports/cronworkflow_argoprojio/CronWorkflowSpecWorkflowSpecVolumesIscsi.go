...
type CronWorkflowSpecWorkflowSpecVolumesIscsi struct {
	...
	SecretRef *CronWorkflowSpecWorkflowSpecVolumesIscsiSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
