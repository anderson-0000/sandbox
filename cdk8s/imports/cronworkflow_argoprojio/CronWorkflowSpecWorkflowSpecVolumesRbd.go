...
type CronWorkflowSpecWorkflowSpecVolumesRbd struct {
	...
	SecretRef *CronWorkflowSpecWorkflowSpecVolumesRbdSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
