...
type CronWorkflowSpecWorkflowSpecTemplateDefaultsVolumesIscsi struct {
	...
	SecretRef *CronWorkflowSpecWorkflowSpecTemplateDefaultsVolumesIscsiSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
