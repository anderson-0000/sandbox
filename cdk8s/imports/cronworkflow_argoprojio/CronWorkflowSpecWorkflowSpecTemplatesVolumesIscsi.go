...
type CronWorkflowSpecWorkflowSpecTemplatesVolumesIscsi struct {
	...
	SecretRef *CronWorkflowSpecWorkflowSpecTemplatesVolumesIscsiSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
