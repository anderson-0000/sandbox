...
type WorkflowTemplateSpecTemplatesDagTasksArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowTemplateSpecTemplatesDagTasksArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
