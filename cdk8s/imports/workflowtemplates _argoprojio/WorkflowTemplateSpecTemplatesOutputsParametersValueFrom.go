...
type WorkflowTemplateSpecTemplatesOutputsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowTemplateSpecTemplatesOutputsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
