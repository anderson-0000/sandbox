...
type WorkflowTemplateSpecTemplateDefaultsVolumesScaleIo struct {
	Gateway *string `field:"required" json:"gateway" yaml:"gateway"`
	SecretRef *WorkflowTemplateSpecTemplateDefaultsVolumesScaleIoSecretRef `field:"required" json:"secretRef" yaml:"secretRef"`
