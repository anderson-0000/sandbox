...
type WorkflowTemplateSpecTemplatesDagTasksHooksArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowTemplateSpecTemplatesDagTasksHooksArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
