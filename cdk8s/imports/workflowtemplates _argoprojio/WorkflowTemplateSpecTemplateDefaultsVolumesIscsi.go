...
type WorkflowTemplateSpecTemplateDefaultsVolumesIscsi struct {
	...
	SecretRef *WorkflowTemplateSpecTemplateDefaultsVolumesIscsiSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
