...
type WorkflowTemplateSpecTemplateDefaultsResource struct {
	...
	ManifestFrom *WorkflowTemplateSpecTemplateDefaultsResourceManifestFrom `field:"optional" json:"manifestFrom" yaml:"manifestFrom"`
