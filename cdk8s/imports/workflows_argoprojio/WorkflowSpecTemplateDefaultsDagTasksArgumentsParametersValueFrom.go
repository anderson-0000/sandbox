...
type WorkflowSpecTemplateDefaultsDagTasksArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowSpecTemplateDefaultsDagTasksArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
