...
type WorkflowSpecTemplatesDagTasksArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowSpecTemplatesDagTasksArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
