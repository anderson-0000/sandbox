...
type WorkflowSpecTemplatesInputsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowSpecTemplatesInputsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
