...
type WorkflowSpecHooksArgumentsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowSpecHooksArgumentsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
