...
type WorkflowSpecTemplateDefaultsVolumesIscsi struct {
	...
	SecretRef *WorkflowSpecTemplateDefaultsVolumesIscsiSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
