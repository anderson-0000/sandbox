...
type WorkflowSpecTemplatesOutputsParametersValueFrom struct {
	ConfigMapKeyRef *WorkflowSpecTemplatesOutputsParametersValueFromConfigMapKeyRef `field:"optional" json:"configMapKeyRef" yaml:"configMapKeyRef"`
