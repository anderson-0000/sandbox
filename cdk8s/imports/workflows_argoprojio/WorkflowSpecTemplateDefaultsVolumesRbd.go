...
type WorkflowSpecTemplateDefaultsVolumesRbd struct {
	...
	SecretRef *WorkflowSpecTemplateDefaultsVolumesRbdSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
